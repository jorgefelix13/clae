...
// Consulta para obtener los registros de Psicologia en la fecha seleccionada
$sql = "SELECT * FROM recepcionm WHERE REC_Area = 'Psicologia' AND REC_Fecha = ? ORDER BY REC_Horaini";
...
<head>
    ...
    <title>Agenda de Psicologia</title>
</head>
<body>
    <h1>Agenda de Psicologia</h1>
