...
// Consulta para obtener los registros de Medicina en la fecha seleccionada
$sql = "SELECT * FROM recepcionm WHERE REC_Area = 'Medicina' AND REC_Fecha = ? ORDER BY REC_Horaini";
...
<head>
    ...
    <title>Agenda de Medicina</title>
</head>
<body>
    <h1>Agenda de Medicina</h1>
